...
const Contact = () => {
  return (
    <div id="contact" className="bg-black text-white py-20" id="contact">
          ...
          <div className="flex-1">
            ...
            <div className='mb-4 mt-8'>
                ...
                <a href="mailto:youremail@example.com" className='hover:underline'>
                    taseemakhtar736@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-green-400 mr-2'></FaPhone>
                <span>+923149240056</span>
            </div>
            <div className='mb-4'>
                <FaLinkedin  className='inline-block text-green-400 mr-2'></FaLinkedin>
                <span>Taseem Akhter Abbasi</span>
            </div>
            <div className='mb-4'>
                <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                <span>greenValley hostel, rehman Abad rawalpindi pakistan</span>
            </div>
          </div>
